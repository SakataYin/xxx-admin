<template>
  <div>
    <div style="margin: 10px 0">
      ...
      <el-select clearable v-model="type" placeholder="请选择题目的类型" style="width: 200px" class="ml-5">
...
<!--          {{scope.row.courseId}}-->
          <span v-for="kcourse in kcourses" v-if="scope.row.courseId === kcourse.id">{{kcourse.name}}</span>
        </template>
      </el-table-column>
    ...
    <el-dialog title="信息" :visible.sync="dialogFormVisible" width="40%" :close-on-click-modal="false">
      <el-form label-width="120px" size="small" style="width: 80%; margin: 0 auto">
        ...
        <el-form-item type="textarea" label="答案" v-if="form.type ===3">
