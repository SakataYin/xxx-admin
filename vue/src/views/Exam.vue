<template>
  <div>
    ...
    <div style="margin: 10px 0">
      ...
      <!-- <el-upload action="http://localhost:9090/exam/import" :show-file-list="false" accept="xlsx" :on-success="handleExcelImportSuccess" style="display: inline-block">
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'"
      ...
      <el-table-column prop="courseId" label="设置考卷">
        <template slot-scope="scope">
<!--          {{scope.row.id}}-->
          <el-button type="primary" @click="serPaper(scope.row.id)">设置</el-button>
        </template>
      </el-table-column>
    ...
    <el-dialog title="试卷" :visible.sync="dialogFormVisible1" width="40%" :close-on-click-modal="false">
    ...
    <el-dialog title="信息" :visible.sync="dialogFormVisible" width="40%" :close-on-click-modal="false">
      <el-form label-width="120px" size="small" style="width: 80%; margin: 0 auto">
        ...
        <el-form-item label="开始时间">
          <el-date-picker v-model="form.time" type="datetime" format="yyyy-MM-dd HH:mm" value-format="yyyy-MM-dd HH:mm"
